...
function SideNav({ params }) {
  ...
  const CreateNewDocument = async () => {
    if (documentList?.length >= MAX_FILE) {
      toast("Upgrade your plan to create more documents", {
        description:
          "You have reached the maximum limit of documents in this workspace.",
        action: {
          label: "Upgrade",
    ...
    if (!createdBy) {
      console.error("User email is undefined. Cannot create document.");
      setLoading(false);
      return;
    }
